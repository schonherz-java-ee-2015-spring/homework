...
public class AdapterPattern {
	public static RoundHole rh = new RoundHole(5);
	public static SquarePegAdapter spa;
	public static void main(String[] args) {
		...
		System.out.println(SquarePegAdapter.sp);
//		System.out.println(spa.getClass());
	}
}
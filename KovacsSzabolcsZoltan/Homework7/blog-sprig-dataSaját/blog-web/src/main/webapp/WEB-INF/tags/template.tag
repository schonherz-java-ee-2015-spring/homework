			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<c:if test="${ pageContext.request.userPrincipal == null  }">
						...
						<li><a href="<c:url value="/pages/registration.jsp"/>">Sign
								up</a></li>
					</c:if>
					<c:if test="${ pageContext.request.userPrincipal != null  }">
					...
					<li><a href="<c:url value="/pages/admin/roles.jsp" />">Roles</a></li>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="well">
<!-- 					<h4>Blog search by category</h4> -->
<!-- 					<div class="input-group"> -->
<!-- 						<input type="text" id="searchCategory" class="form-control"> -->
<!-- 						<span class="input-group-btn"> -->
<!-- 							<button class="btn btn-default" type="button" id="search" onclick="searchCategory();"> -->
<!-- 								<span class="glyphicon glyphicon-search"></span> -->
<!-- 							</button> -->
<!-- 						</span> -->
<!-- 					</div> -->
...
<%-- 									<li>${category }</li> --%>
									<li><a href="#" onclick="searchCategory('${category }')">${category }</a></li>
								</c:forEach>
							</ul>
						</div>
					</div>

		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="well">
					...
					<div class="input-group">
						<input type="text" id="searchCategory" class="form-control"> <span
							class="input-group-btn">
							<button class="btn btn-default" type="button" id="search" onclick="searchBlogsByCategory();">
								<span class="glyphicon glyphicon-search"></span>
							</button>
						</span>
					</div>
						...
						<div class="col-lg-6">
							<c:forEach items="${categories}" var="category">
								<ul class="list-unstyled">
									<li><a href="#"
								onclick="searchParameterizedBlogsByCategory('${category.key}');" >${category.key}</a></li>
								</ul>
							</c:forEach>
						</div>
						<!-- /.col-lg-6 -->

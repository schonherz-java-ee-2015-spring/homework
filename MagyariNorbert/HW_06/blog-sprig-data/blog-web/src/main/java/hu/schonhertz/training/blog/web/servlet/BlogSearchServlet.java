...
public class BlogSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse resp) throws ServletException, IOException {
		...
		String categoryparam = request.getParameter("categoryparam");
		...
		else if(!StringUtils.isEmpty(category))
		{
			...
			Integer pageValue = Integer.valueOf(page);
			BlogSearchResult result = blogService.searchBlogByCategory(category, pageValue, sizeInt);
		...
		else if(!StringUtils.isEmpty(categoryparam))
		{
			Integer sizeInt = Integer.valueOf(size);

			Integer pageValue = Integer.valueOf(page);
			BlogSearchResult result = blogService.searchBlogByCategory(categoryparam, pageValue, sizeInt);
			List<BlogVo> blogVos = result.getBlogVos();
			Long blogSize = result.getTotalElement();

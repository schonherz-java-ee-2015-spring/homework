...
public class Main {
	...
	public static void main(String[] args) {
		...
		java.util.List<Developer> developers = DeveloperReader.readFromTextFile();
	...
	public void lambda(Developer d) {
	...
	public static void synchronyzeTest() {
	 ...
	 * nem mindegy hogy egy mezei júzernek), I want a real-time(folyamatosan,
	 * míg a program fut) report for those servers, which are not running. The
	 * report should tell that which system administrators have right for those
	 * servers.
	 * 
	 * real-time report: continuously while the program is running (every 10
	 * sec) report: write out on console. Format: serverName (what is not
	 * running) and the list of administrators name. servers: server.txt
	 * contains them: 1) ID of the server 2) Name of the server 3) type 4)
	 * status of server
	 * 
	...
	// }
	//
	// // what happen inside of the forEach - Each dev will be the parameter of
	// this method
	...
	// servers, which are not running.
	// * The report should tell that which system administrators have right for
	// those servers.
	// *
	// * -----------------------------
	// * real-time report: continuously while the program is running (every 10
	// sec)
	// * report: Write out on console. Format: serverName (what is not running)
	// and the list of administrators' name
	...
	// *
	// * NOTE: Should be in separate project or you can write the code here, as
	// you prefer
	// * If you finished it, please put the project folder into homework
	// repository under your subfolder (your name)
	// * !!!And Push it!!!

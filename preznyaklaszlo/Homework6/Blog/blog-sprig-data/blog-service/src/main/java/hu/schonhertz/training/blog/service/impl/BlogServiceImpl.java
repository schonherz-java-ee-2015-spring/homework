...
public class BlogServiceImpl implements BlogService {
	...
	public List<String> getAllCategory() {
		...
		for (Blog blog : blogs) {
			if (!categories.contains(blog.getCategory())) {
	...
	@Override
	public BlogSearchResult getAllBlogByCategory(String category, Integer page, Integer size) {
		Sort sort = new Sort(Direction.DESC, "createDate");
		Pageable pageable = new PageRequest(page, size, sort);
		Page<Blog> blogsPage = blogRepository.findAllByCategory(category, pageable);

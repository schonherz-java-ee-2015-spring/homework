package hu.schonherz.java.training.hw4.dao;
...
public interface UserDao {
	...
	/**
	 * Updates an existing {@link User} in the User table.
	 * @param user The {@link User} object which need an update.
	 * @return A boolean indicating the success of the operation.
	 */
	 ...
	 * @return A boolean indicating the success of the operation.
	 */
	boolean deleteUser( int id, String name );
	 ...
	 * @return A {@link List} of {@link Product}s containing all the products the user ordered.
	 */
	List<Product> getOrdersOfUser(int id, String name);
}

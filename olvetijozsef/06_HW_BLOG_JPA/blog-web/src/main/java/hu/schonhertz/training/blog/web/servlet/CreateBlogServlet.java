...
public class CreateBlogServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		CategoryVo cvo = null;
		try {
			cvo = categoryService.getCategoryByName(categoryName);
		...
		if (cvo == null) {
			...
			categoryService.createCategory(cvo);
			cvo = categoryService.getCategoryByName(cvo.getName());
		}
		blogVo.setCategory(cvo);
		blogVo.setCreateDate(new Date(System.currentTimeMillis()));
